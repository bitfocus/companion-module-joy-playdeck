...
function playout(command: PlayoutCommand): PlaydeckCommandV4 {
	return {
		...
		command: `${command}`,
		description: `${playoutCommands[command]} the Clip in the Channel. If you dont provide Clip, the first Clip of the Block will be used. If you dont provide Block/Clip, the selected Block/Clip will be used. Will skip inactive Clips.`,
		arg1: 'CHANNEL',
		arg2: 'BLOCK',
		arg3: 'CLIP',
	}
...
function playoutList(command: PlayoutCommand): PlaydeckCommandV4 {
	return {
		...
		description: `${playoutCommands[command]} the Clip in the List (Left or Rigth). If you dont provide Clip, the first Clip of the Block will be used. If you dont provide Block/Clip, the selected Block/Clip will be used. Will skip inactive Clips.`,
		arg1: 'LIST',
		arg2: 'BLOCK',
		arg3: 'CLIP',
	}
